                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="footer-widget mb-50">
                        <div class="footer-logo mb-35">
                            <a href="index.html"><img src="{{ asset('assets/img/logo/w_logo.png') }}"
                                    alt="img"></a>
                        </div>
                            ...
                            <ul>
                                <li>
                                    <div class="f-rc-thumb">
                                        <a href="#"><img
                                                src="{{ asset('assets/img/blog/f_rc_img01.jpg') }}"
                                                alt="img"></a>
                                    </div>
                                ...
                                <li>
                                    <div class="f-rc-thumb">
                                        <a href="#"><img
                                                src="{{ asset('assets/img/blog/f_rc_img02.jpg') }}"
                                                alt="img"></a>
                                    </div>
                                    <div class="f-rc-content">
                                        <span>19 Jun, 2019</span>
                    ...
                    <div class="footer-widget mb-50">
                        ...
                        <div class="fw-link">
                            <ul>
                                ...
                                <li><a href="#"><i class="fas fa-caret-right"></i> Terms & Conditions</a>
                                </li>
                    ...
                    <div class="footer-widget mb-50">
                        ...
                        <div class="f-support-content">
                            ...
                            <a href="#" class="f-download-btn"><img
                                    src="{{ asset('assets/img/images/f_download_btn01.png') }}"
                                    alt="img"></a>
                            <a href="#" class="f-download-btn"><img
                                    src="{{ asset('assets/img/images/f_download_btn02.png') }}"
                                    alt="img"></a>
                        </div>
                    </div>
                </div>
